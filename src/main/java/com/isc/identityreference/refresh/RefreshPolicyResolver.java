...
@Component
public class RefreshPolicyResolver {
    ...
    public RefreshPolicy resolve(String providerId){
        ...
        return new RefreshPolicy(providerId,p.getVersion(),p.getTtl(),p.getStaleGrace(),p.getRefreshBeforeExpiry(),p.getMaxRequestsPerSecond(),
                p.getMaxConcurrentRequests(),p.getMaxAttempts(),p.getInitialBackoff(),p.getMaxBackoff(),p.getTimeout(),
