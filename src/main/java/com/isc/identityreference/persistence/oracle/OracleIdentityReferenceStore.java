...
public final class OracleIdentityReferenceStore implements IdentityReferenceStore {
 ...
 public IdentityReference save(IdentityReference r, Instant nextRefreshAt, long policyVersion){
  ...
  e.setPolicyVersion(policyVersion); e.setRefreshStatus("SUCCESS"); e.setRefreshError(null); e.setRefreshRetryCount(0); e.setCreatedAt(r.createdAt()); e.setUpdatedAt(r.updatedAt()); repository.save(e); return r;
 }
