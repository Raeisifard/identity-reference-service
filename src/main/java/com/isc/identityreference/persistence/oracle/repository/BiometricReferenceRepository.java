...
public interface BiometricReferenceRepository extends JpaRepository<BiometricReferenceEntity,String>{
    Optional<BiometricReferenceEntity> findByIdentityReferenceIdAndModelIdAndModelVersionAndSourcePhotoVersion(String identityReferenceId,String modelId,String modelVersion,String sourcePhotoVersion);
}
