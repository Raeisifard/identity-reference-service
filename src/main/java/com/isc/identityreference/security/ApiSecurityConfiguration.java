...
@Configuration
@EnableConfigurationProperties({ApiSecurityProperties.class, ApiRateLimitProperties.class, com.isc.identityreference.observability.ObservabilityProperties.class})
