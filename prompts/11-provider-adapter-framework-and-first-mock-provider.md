# 11-provider-adapter-framework-and-first-mock-provider.md

Use prompts/00-ai-agent-rules.md first.

## Objective
Implement provider adapter configuration and a realistic mock national-agency adapter; keep real credentials/endpoints external.
