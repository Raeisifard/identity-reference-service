# 09-policy-driven-scheduler-and-quiet-window-refresh.md

Use prompts/00-ai-agent-rules.md first.

## Objective
Implement quota-aware, jittered, quiet-window scheduled refresh with distributed worker safety and dry-run planning.
