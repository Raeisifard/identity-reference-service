# 15-failure-handling-idempotency-locking-and-recovery.md

Use prompts/00-ai-agent-rules.md first.

## Objective
Harden locking, leases, idempotency, retries, timeouts, circuit breakers and crash recovery; test outages and duplicates.
