# Phase 19 — Automated tests and end-to-end validation

Use prompts/00-ai-agent-rules.md first.

## Objective
Expand unit, integration, contract and end-to-end tests including deterministic scheduler, refresh, failure/recovery and cache rebuild tests.
