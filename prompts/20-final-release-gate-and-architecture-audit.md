# 20-final-release-gate-and-architecture-audit.md

Use prompts/00-ai-agent-rules.md first.

## Objective
Perform final architecture, security and scalability audit, full verification, release-blocker fixes and a release checklist.
