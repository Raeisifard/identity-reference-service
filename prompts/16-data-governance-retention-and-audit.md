# 16-data-governance-retention-and-audit.md

Use prompts/00-ai-agent-rules.md first.

## Objective
Implement retention, deletion/revocation, audit and policy-version traceability without sensitive audit payloads.
